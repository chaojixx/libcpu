...
static void do_v7m_exception_exit(CPUARMState *env) {
    ...
    HPRINTF(" R3=0x%x R4=0x%x R5=0x%x R6=0x%x R7=0x%x R8=0x%x R9=0x%x R10=0x%x R11=0x%x R12=0x%x R2=0x%x R1=0x%x R0=0x%x\n",
                env->regs[3], env->regs[4],  env->regs[5], env->regs[6], env->regs[7],  env->regs[8],
                env->regs[9],  env->regs[10], env->regs[11], env->regs[12], env->regs[2], env->regs[1],  env->regs[0]);
        ...
        case EXCP_SWI:
            if (semihosting_enabled) {
                ...
                if (env->thumb) {
                    ...
                    mask = arm_ldl_code(env->regs[15] - 4, env->bswap_code) & 0xffffff;
                }
